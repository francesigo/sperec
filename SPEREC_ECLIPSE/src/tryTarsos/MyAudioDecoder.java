...
public class MyAudioDecoder {
    ...
    public static MyAudioInfo decode(String resName)  {
    ...
    */
    ...
    public static MyAudioInfo decode(String filePathString) { //throws IOException, WavFileException  {
        ...
        if(f.exists() && !f.isDirectory()) {
            ...
            switch(ext1) {
                ...
                case "wav": // 	System.out.println("IT IS A WAV");
                    aInfo = decodeWav(filePathString);
                    break;
    ...
    //--------------------------------------------------------------------------
    private static MyAudioInfo decodeWavHlp(MyWavFile readWavFile) throws IOException, Exception {
    ...
    private static MyAudioInfo decodeWav(String filePathString)  {
        ...
        try {
            MyWavFile readWavFile = MyWavFile.openWavFile(new File(filePathString));
            aInfo = decodeWavHlp(readWavFile);
        } catch (IOException e) {
        } catch (Exception e) {
