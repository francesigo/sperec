...
public class MyWavHeader {
     ...
     */
    public MyWavHeader(short format, short numChannels, int sampleRate, short bitsPerSample, int numBytes) {
        mFormat = format;
     ...
     */
    public MyWavHeader setFormat(short format) {
        mFormat = format;
        return this;
    }
     ...
     * @return reference to this WaveHeader instance.
     */
    public MyWavHeader setNumChannels(short numChannels) {
        mNumChannels = numChannels;
        return this;
    }
     ...
     * @return reference to this WaveHeader instance.
     */
    public MyWavHeader setSampleRate(int sampleRate) {
        mSampleRate = sampleRate;
        return this;
    }
     ...
     * @return reference to this WaveHeader instance.
     */
    public MyWavHeader setBitsPerSample(short bitsPerSample) {
        mBitsPerSample = bitsPerSample;
        return this;
    }
     ...
     * @return reference to this WaveHeader instance.
     */
    public MyWavHeader setNumBytes(int numBytes) {
        mNumBytes = numBytes;
        return this;
    }
