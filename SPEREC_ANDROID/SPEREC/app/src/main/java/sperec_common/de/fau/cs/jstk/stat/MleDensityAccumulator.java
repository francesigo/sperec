...
public final class MleDensityAccumulator {
	// Sigona private static Logger logger = Logger.getLogger(MleDensityAccumulator.class);
	...
	public static void MleUpdate(Density din, MleOptions opt, 
		...
		if  (acc.occ < opt.minOcc) {
			System.out.println("occ < minOcc : No update of density " + din.id); // Sigona logger.info
			return;
		}
